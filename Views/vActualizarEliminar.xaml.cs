...
public partial class vActualizarEliminar : ContentPage
{
    ...
    private void btnActualizar_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                await DisplayAlert("ERROR", "Los campos son obligatorios.", "Cerrar");
                return;
            }
            ...
            using (WebClient cliente = new WebClient())
            {
                ...
                await DisplayAlert("Servidor", responseString, "Cerrar");
                ...
                {
                    await DisplayAlert("ERROR", "No se puede actualizar el estudiante.", "Cerrar");
                }
            }
        }
